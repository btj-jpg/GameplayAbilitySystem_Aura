...
int32 AAuraCharacter::GetAttributePointReword_Implementation(int32 InPlayerLevel) const
{
	AAuraPlayerState* AuraPlayerState = GetPlayerState<AAuraPlayerState>();
	check(AuraPlayerState);
...
int32 AAuraCharacter::GetSpellPointReword_Implementation(int32 InPlayerLevel) const
{
	AAuraPlayerState* AuraPlayerState = GetPlayerState<AAuraPlayerState>();
	check(AuraPlayerState);
...
void AAuraCharacter::ShowMagicCircle_Implementation(UMaterialInterface* Material)
{
	...
	if (AuraPC)
	{
		AuraPC->ShowMagicCircle(Material);
